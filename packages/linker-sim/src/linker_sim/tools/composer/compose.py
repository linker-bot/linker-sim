...
Usage:
    python -m linker_sim.tools.composer.compose <workstation_dir> [--check-drift]
...
def _add_header_comment(xml_text: str, *, recipe_name: str, recipe_sha: str) -> str:
    ...
    header = (
        f"<!-- Generated by linker_sim.tools.composer (version {COMPOSER_VERSION}). "
        f"Workstation: {recipe_name}. Recipe sha256: {recipe_sha}. "
        f"Do not edit by hand; re-run `python -m linker_sim.tools.composer.compose "
        f"<workstation>`. -->\n"
    )
