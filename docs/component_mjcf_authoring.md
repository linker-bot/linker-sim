...
Run `python -m linker_robot_assets.validate_component_mjcf <component_dir> [--variant NAME]`.
...
- [ ] `python -m linker_robot_assets.validate_component_mjcf <component_dir>` reports `=> overall: OK`.
